        ...
        <div class="FriendContent">
            <button id='myBtn' class="plusButton addfriendlist"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 svgfriendlist" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"> <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" /> </svg></button>
                ...
                <tr>
                    ...
                    echo"<td><a href='friendlistedit.php?id=".$row['FriendsID']."'><svg xmlns='http://www.w3.org/2000/svg' class='h-6 w-6' fill='none' viewBox='0 0 24 24' id = 'EditButton'  stroke='currentColor' stroke-width='2'>
                    <path stroke-linecap='round' stroke-linejoin='round' d='M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z' />
                    </svg></a></td>";
                    echo"<td><a href='friendsdelete.php?id=".$row['FriendsID']."'><svg xmlns='http://www.w3.org/2000/svg' class='h-6 w-6' fill='none' viewBox='0 0 24 24' id ='DeleteButton' stroke='currentColor' stroke-width='2'>
